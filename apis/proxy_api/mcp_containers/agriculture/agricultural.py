...
def handle_greeting(state: AgentState):
    return {"final_prompt": "Namaste! I am AgriSeva-AI. How can I help your farm today?"}
...
async def format_final_prompt(state: AgentState):
    ...
    base_system_prompt = "You are AgriSeva-AI2.0. Answer using the provided context."
