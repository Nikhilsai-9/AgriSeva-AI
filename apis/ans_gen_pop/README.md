...
FastAPI service that retrieves Package of Practices (PoP) context from **pop_v2**, filters chunks with an LLM, then generates a farmer-facing answer from the relevant excerpts. Answers are PoP-only and do **not** include the AgriSeva-AI agent expert-review / 2-hour footer.
