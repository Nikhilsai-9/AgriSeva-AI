...
export class ResponseAdherenceTableResponse {
  ...
  @JSONSchema({ description: 'Total AgriSeva-AI questions asked in the filtered range', example: 47, type: 'number', readOnly: true })
  @IsNumber()
  agrisevaQuestionAsked: number;
  ...
  @JSONSchema({ description: 'AgriSeva-AI questions completed within 120 minutes', example: 41, type: 'number', readOnly: true })
  @IsNumber()
  ...
  @JSONSchema({ description: 'AgriSeva-AI questions passed to the GDB', example: 14, type: 'number', readOnly: true })
  @IsNumber()
  agrisevaPassedQuestions: number;
  ...
  @JSONSchema({ description: 'Average AgriSeva-AI response time in minutes', example: 102, type: 'number', readOnly: true })
  @IsNumber()
  ...
  @JSONSchema({ description: 'AgriSeva-AI questions still in process', example: 6, type: 'number', readOnly: true })
  @IsNumber()
  agrisevaInProcessCount: number;

  @JSONSchema({ description: 'WhatsApp adherence percentage', example: 80.43, type: 'number', readOnly: true })
  @IsNumber()
  whatsappAdherencePct: number;

  @JSONSchema({ description: 'AgriSeva-AI adherence percentage', example: 87.23, type: 'number', readOnly: true })
  @IsNumber()
