...
// console.log("closedVsTotalQuestions---", closedVsTotalQuestions); 
  ...
  async verifyUser(userId: string, source = 'agriseva',  isVerified?: boolean,  ): Promise<any> {
    try {
      if (!userId) {
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;">
                  ...
                  <tr>
                    <td style="padding:40px;">
                      ...
                      <p style="font-size:16px;color:#333333;line-height:1.6;">
                        You can now log in and access all features available on AgriSeva-AI.
                      </p>
                      ...
                      <p style="font-size:16px;color:#333333;line-height:1.6;">
                        Thank you,<br />
                        <strong>AgriSeva-AI Team</strong>
                      </p>
                    </td>
                  </tr>
