...
export interface QueueDetailsResponse {
  /** All time-bound (AGRISEVA_AI/WHATSAPP, auto-allocated) questions ever received. */
  ...
  /** AGRISEVA_AI/WHATSAPP questions with auto-allocation turned OFF (handled manually). */
  ...
  /** Time-bound (AGRISEVA_AI/WHATSAPP) questions with no moderator yet. */
...
export type QueueSectionName =
  ...
  | 'moderatorAllocated'
  | 'availableModerators'
  // Source-split variants (time-bound = AGRISEVA_AI/WHATSAPP, manual = AGRI_EXPERT/OUTREACH)
