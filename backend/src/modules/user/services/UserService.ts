                      ...
                      <tr>
                        <td style="padding: 36px 40px 24px;">
                          ...
                          <p style="margin: 0 0 28px; font-size: 15px; color: #3a3a35; line-height: 1.6; font-family: 'Outfit', sans-serif;">
                            A user has submitted a verification request on the AgriSeva-AI Reviewer System and is awaiting your approval. Please review the details below and take the appropriate action.
                          </p>
                      ...
                      <tr>
                        <td style="padding: 24px 40px 32px;">
                          <p style="margin: 0; font-size: 12px; color: #9a9a95; line-height: 1.6; font-family: 'Outfit', sans-serif;">
                            This is an automated notification from the <strong style="color: #6b6b66;">AgriSeva-AI Web Application</strong>.
                          ...
                          <p style="margin: 10px 0 0; font-size: 12px; color: #b8b8b3; font-family: 'Outfit', sans-serif;">
                            © ${new Date().getFullYear()} Annam.Ai · desk.agriseva.ai
                          </p>
                        </td>
                      </tr>
