...
export class UserRepository implements IUserRepository {
   ...
   *  blocked, with an empty feedbacksAssigned AND no time-bound (AGRISEVA_AI/WHATSAPP)
   ...
   *  (AGRISEVA_AI/WHATSAPP) assigned question. Feedback counts as a time-bound item, so a
