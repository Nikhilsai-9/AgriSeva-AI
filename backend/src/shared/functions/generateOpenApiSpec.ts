...
const getOpenApiServers = () => {
  ...
  const appUrl = appConfig.url || 'https://desk.agriseva.ai/';
...
export function generateOpenAPISpec(
  ...
  const spec = routingControllersToSpec(storage, routingControllersOptions, {
    openapi: '3.0.3',
    info: {
      title: 'AgriSeva-AI API Documentation',
      version: '1.0.0',
      description: 'API documentation for the AgriSeva-AI platform',
      contact: {
        name: 'AgriSeva-AI Team',
