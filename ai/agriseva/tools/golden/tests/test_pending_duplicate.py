...
from agriseva.tools.golden.golden_api import PendingDuplicateCheckRequest
from agriseva.tools.golden.golden_core import (
    PendingQuestionCandidate,
    parse_created_before,
)
from agriseva.tools.golden.golden_pending_duplicate import (
    check_pending_duplicate,
    duplicate_return_id,
    pick_duplicate_winner,
)
from agriseva.tools.golden.gemma_classifier import _parse_pending_duplicate_response
...
async def test_check_pending_duplicate_exact_bypass(monkeypatch):
    ...
    monkeypatch.setattr(
        "agriseva.tools.golden.golden_pending_duplicate.pending_exact_search",
        mock_exact,
    )
    monkeypatch.setattr(
        "agriseva.tools.golden.golden_pending_duplicate.pending_vector_search",
        mock_vector,
    )
    monkeypatch.setattr(
        "agriseva.tools.golden.golden_pending_duplicate.filter_pending_duplicate_batch",
        mock_llm,
    )
