...
def upload_question_to_reviewer_system(
    ...
    - source (str): Question channel identifier (e.g. AGRISEVA_AI, WHATSAPP, AGRISEVA_AI_WEBAPP).
    ...
    - user_id (str, optional): LibreChat user id (from x-user-id). Injected by the agent for AGRISEVA_AI uploads.
    - message_id (str, optional): LibreChat message id (from x-message-id). Injected by the agent for AGRISEVA_AI uploads.
    """
