...
SEGMENT_RANKING_SYSTEM_PROMPT = """You are AgriSeva-AI's source-segment relevance ranker.
...
RANKED_SOURCE_COMPRESSION_SYSTEM_PROMPT = """You are AgriSeva-AI's constrained
answer compressor.
