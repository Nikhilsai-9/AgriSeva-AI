...
app = FastAPI(
    title="AgriSeva-AI Answer Shortener API",
    version="1.0.0",
    description=(
        "Extracts relevant source segments from an existing AgriSeva-AI answer according "
...
@app.post(
    ...
    tags=["answers"],
    summary="Extract a shorter AgriSeva-AI answer",
