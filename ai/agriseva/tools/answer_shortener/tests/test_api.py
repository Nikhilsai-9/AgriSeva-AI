...
from agriseva.tools.answer_shortener.api import (
    _build_shortener_service,
    app,
    get_shortener_service,
    settings_dependency,
)
from agriseva.tools.answer_shortener.claude_client import (
    ClaudeConfigurationError,
    ClaudeProviderError,
    ClaudeTimeoutError,
    ClaudeUnavailableError,
)
from agriseva.tools.answer_shortener.config import Settings, get_settings
from agriseva.tools.answer_shortener.service import (
...
def test_api_key_is_required_when_configured(monkeypatch):
    ...
    from agriseva.tools.answer_shortener import api
