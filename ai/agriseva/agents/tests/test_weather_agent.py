...
from agriseva.agents.weather_agent import classify_weather_query
...
async def test_classify_weather_query_traces_gemma_response(caplog):
    ...
    with caplog.at_level(logging.INFO, logger="agriseva.agents.thread_trace"):
        with patch("agriseva.agents.weather_agent.httpx.AsyncClient", return_value=mock_client):
