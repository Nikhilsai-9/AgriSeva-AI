...
from agriseva.agents.daily_price_agent import (
    _build_tool_args,
    _heuristic_intent,
    _normalize_intent,
...
async def test_extract_daily_price_intent_uses_gemma_json():
    ...
    with patch("agriseva.agents.daily_price_agent.httpx.AsyncClient", return_value=mock_client):
...
async def test_daily_price_asks_gemma_when_tool_empty():
    with (
        patch(
            "agriseva.agents.daily_price_agent.extract_daily_price_intent",
        ...
        patch(
            "agriseva.agents.daily_price_agent.call_mandi_price_tool",
            new_callable=AsyncMock,
            return_value={"price_records": [], "stats": {}},
        ),
        patch(
            "agriseva.agents.daily_price_agent.synthesize_daily_price_answer",
            new_callable=AsyncMock,
