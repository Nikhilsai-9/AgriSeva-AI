...
from agriseva.agents.planner_rules import classify_follow_up_heuristic
...
class TestGraphWiring:
    def test_compiled_graph_has_follow_up_node(self):
        from agriseva.agents.agriseva import graph
    ...
    def test_route_after_planner_supports_follow_up_in_map(self):
        ...
        from agriseva.agents.agriseva import _build_graph
