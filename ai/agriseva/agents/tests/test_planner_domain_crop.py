...
from agriseva.agents.domains import apply_tool_flags_from_domain, normalize_crop_value
from agriseva.agents.planner import (
    _apply_domain_and_crop_async,
    planner_output_to_plan,
    PlannerOutput,
)
from agriseva.agents.planner_rules import extract_crop_from_text
...
async def test_never_crop_domain_forces_all():
    ...
    with patch(
        "agriseva.agents.planner.is_crop_specific_question",
