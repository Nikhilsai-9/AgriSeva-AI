...
from agriseva.agents.follow_up_node import (
    _previous_ai_answer,
    _latest_human_text,
    _type_instruction,
    follow_up_node,
)
from agriseva.agents.prompts import FOLLOW_UP_SYSTEM_PROMPT
...
async def test_follow_up_node_returns_llm_answer(monkeypatch):
    ...
    from agriseva.agents import follow_up_node as fu_module
