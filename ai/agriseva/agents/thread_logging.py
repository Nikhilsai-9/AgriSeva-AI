...
from agriseva.agents.config import resolve_thread_id
from agriseva.agents.thread_log_mongo import (
...
_THREAD_LOG_LOGGER_PREFIX = "agriseva"


class ThreadLogFilter(logging.Filter):
    """Keep only agriseva application loggers in per-thread files."""
