...
from agriseva.agents.resolution_trace import trace_resolution
from agriseva.agents.state import Location, PlannerEntities, PlannerPlan
...
def extract_crop_from_text(text: str) -> Optional[str]:
    ...
    try:
        from agriseva.agents.crop_chemical_resolver import (
