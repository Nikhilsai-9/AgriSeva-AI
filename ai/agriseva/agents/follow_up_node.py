...
from agriseva.agents.config import FOLLOW_UP_MODEL, get_minimax_chat_model
from agriseva.agents.llm_trace import trace_llm_request, trace_llm_response
from agriseva.agents.prompts import FOLLOW_UP_SYSTEM_PROMPT, FOLLOW_UP_TYPE_INSTRUCTIONS
...
async def follow_up_node(state: AgriSevaState, config: RunnableConfig) -> dict:
