...
def language_directive_for_synthesis(
    ...
    *,
    ...
    if lang_label is not None and script_language is None:
        from agriseva.agents.translation_catalog import synthesis_lang_label
...
def get_localized_empty_reply_body(
    ...
    *,
    ...
    from agriseva.agents.translation_catalog import get_two_hour_disclaimer
...
def get_localized_state_question(
    ...
    *,
    ...
    from agriseva.agents.translation_catalog import get_state_follow_up
...
def get_localized_crop_question(
    ...
    *,
    ...
    from agriseva.agents.translation_catalog import get_crop_follow_up
