...
COMMANDS = [
    ...
    },
    {
        ...
        "command": [sys.executable, "-m", "agriseva.evaluation.run", "--mode", "live", "--stable-only"],
...
def write_html(rows, command_results):
    ...
    <head>
        <meta charset="utf-8">
        <title>AgriSeva-AI Stable Suite Report</title>
        <style>
            body {{
    ...
    <body>
        <div class="summary">
            <h1>AgriSeva-AI Stable Suite Report</h1>
