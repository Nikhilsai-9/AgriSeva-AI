\# AgriSeva-AI Stable Health Suite
...
This framework provides automated health validation for AgriSeva-AI after deployment.
...
BACKEND\_BASE\_URL=https://desk.agriseva.ai/api
