...
import sys
sys.path.insert(0, "/app/agriseva/ai")

from agriseva.agents.answer_footers import get_time_aware_expert_disclaimer
...
def test_scenario(hour: int, expected_contains: str, script: str = "English", vocal: str = "English"):
    ...
    with patch("agriseva.agents.answer_footers.datetime") as mock_datetime:
