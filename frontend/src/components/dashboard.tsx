        ...
        {!isTrainingUser && goldenData?.questionSourceBreakdown && (
          <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <QuestionSourceCharts
              ...
              agrisevaCount={goldenData.questionSourceBreakdown.agriseva}
            />
            ...
            {goldenData?.questionsAnsweredWithin120Min && (
              <QuestionsAnswered120Min
                ...
                agrisevaCount={goldenData.questionsAnsweredWithin120Min.agriseva}
              />
            )}
             <QuestionsAnsweredAfter120MinProps
                whatsappCount={goldenData?.questionsAnsweredAfter120Min?.whatsapp??0}
                agrisevaCount={goldenData?.questionsAnsweredAfter120Min?.agriseva??0}
          ...
          <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {goldenData?.averageResponseTime && (
              <AverageResponseTime
                ...
                agrisevaAvgTime={goldenData.averageResponseTime.agriseva}
              />
            )}
          </div>
        )}
