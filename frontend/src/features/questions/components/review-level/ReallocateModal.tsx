            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-4">
              ...
              <div className="flex items-center justify-between pt-2 border-t border-border/40">
                <div className="flex items-center gap-3">
                    Pending :- 
                  <TimerDisplay timer={time} status="open" className="border border-red-300 px-3 rounded-full text-red-500 [&>span]:!text-red-500" source="AGRISEVA_AI" size="md" showDays={true} />
                </div>
              </div>
            </div>
