...
const QaQuestionItem = ({
  ...
  const isTimeboundQuestion = question.source === "AGRISEVA_AI" || question.source === "WHATSAPP";
  ...
  `}
    >
      {selectedQuestion === question?.id && (
        <div
          className={`absolute left-0 top-0 bottom-0 w-1 ${question.source === "AGRISEVA_AI"
            ? "bg-blue-500"
