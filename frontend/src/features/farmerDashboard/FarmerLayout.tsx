/**
 * FarmerLayout — the shell for the new Farmer Market Intelligence
 * Dashboard.
 *
    ...
    <div className="w-full bg-amber-100 border-b border-amber-300 text-amber-900 text-xs sm:text-sm">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2 flex items-center gap-2">
        ...
        <p>
          {t(
            "farmer.banner.demo",
            "Demo Data — This dashboard currently renders sample data so you can explore the experience. Live mandi feeds and buyer KYC will be enabled when the production backend is connected."
          )}
        </p>
      </div>
    </div>
          ...
          <Link to="/farmer" className="flex items-center gap-2 min-w-0">
            ...
            <div className="flex flex-col leading-tight min-w-0">
              <span className="text-[11px] uppercase tracking-wider text-emerald-700 font-semibold truncate">
                {t("farmer.brand.kicker", "AgriSeva • Farmer")}
              </span>
