            ...
            return (
              ...
              >
                ...
                <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                  <Row icon={<MapPin className="h-3 w-3" />} label={t("farmer.logistics.route", "Route")}>
                    {opt.from} → {opt.to}
                  </Row>
                  <Row
                    icon={<Calendar className="h-3 w-3" />}
                    label={t("farmer.logistics.eta", "ETA")}
                  >
                    {formatDate(opt.estimatedDeliveryDate)}
                  </Row>
                  <Row
                  ...
                  <Row
                    ...
                    label={t("farmer.logistics.rate", "Rate")}
                  >
                    ₹{opt.ratePerKg}/kg
                  </Row>
                </div>
                <button
                  type="button"
                  className={cn(
                    "mt-3 w-full inline-flex items-center justify-center rounded-xl text-sm font-semibold px-4 py-2 transition-colors",
                    isSelected
                ...
                >
                  {isSelected
                    ? t("farmer.logistics.selected", "Selected")
                    : t("farmer.logistics.select", "Select this transporter")}
                </button>
              </FarmerCard>
            );
          })}
